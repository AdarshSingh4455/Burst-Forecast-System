        ...
        <div className="flex items-center gap-2">
          ...
          <div className="bg-white border border-[#D2E5DF] rounded-md px-2.5 py-1 flex flex-col justify-center min-w-[95px] h-[40px] shadow-xs">
            ...
            <select
              ...
              className="bg-transparent font-bold text-[#102A2A] text-xs focus:outline-none cursor-pointer p-0 -mt-0.5"
            >
              <option value="bust_risk_probability">Bust Risk</option>
              <option value="fragility_score">Rainfall (mm)</option>
              <option value="trust_index">Trust Index</option>
            </select>
          </div>
          ...
          <div className="relative ml-1">
            ...
            <input
              type="text"
              placeholder="Search state, district, dam, asset..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pl-8 pr-3 py-2 bg-white border border-[#D2E5DF] rounded-md text-xs text-[#102A2A] focus:outline-none focus:border-[#00A878] w-[220px] placeholder-[#617874]/60 shadow-xs h-[40px]"
            />
          </div>
